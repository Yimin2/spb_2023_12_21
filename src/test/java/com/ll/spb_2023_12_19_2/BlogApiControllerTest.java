...
class BlogApiControllerTest {
    ...
    public void addArticle() throws Exception {
        ...
        final AddArticleRequest userRequsest = new AddArticleRequest(title, content);

        final String requestBody = objectMapper.writeValueAsString(userRequsest);
        //when
    ...
    @DisplayName("deleteArtice: 블로그 글 삭제에 성공한다.")
    @Test
